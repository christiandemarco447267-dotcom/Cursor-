...
export const LESSONS: Lesson[] = [
  {
    ...
    body: [
      ...
      "Sentia nudges this habit: pair every position with a thesis and revisit it when your mood or the market shifts.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "Sentia tracks both: the ledger records realized gains on every sale so you can see the effect of your decisions.",
    ],
  },
  {
